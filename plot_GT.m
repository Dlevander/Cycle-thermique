function [FIG] = plot_GT(DAT,eta_PiT,eta_PiC,x,y,k_cc)
    ...
    linP23= linspace(DAT(2,2),DAT(2,3),100); %pertes de charges dans chambre combustion
    %preallocation
    ...
    for i=1:length(linT23)
        ...
        linS23(i) = DAT(4,2)+Cp_23(i).*log(linT23K(i)./TK_2) - R_fum(i).*log(linP23(i)/DAT(2,2))*1e-3;
    ...
    grid on
    plot(DAT(4,:),DAT(1,:),'*');
    plot([linS12 linS23],[linT12 linT23],'r')
