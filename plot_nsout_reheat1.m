function [FIG] = plot_nsout_reheat1(DAT,dat7,dat10,dat100,dat110,eta_SiT_HP,eta_SiT_others,nsout)
        close all
...
%% Diagramme h-s
        ...
        plot([SL(374) SV(374)],[HL(374) HV(374)],'-b');
        %plot Pompe Alim 1-2
