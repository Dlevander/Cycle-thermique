...
x_30 = NaN;% XSteam('x_ph',p_30,h_30); = NaN car vapeur surchauffÃƒÂ©e
...
%         end
%         
%     else % travail fourni Ã  la pompe sans bache et sans soutirages
...
%     
%     
%     %%%%%%%% Combustion (dÃ©termination des fractions massiques des fumÃ©es %%%%%%
%     
